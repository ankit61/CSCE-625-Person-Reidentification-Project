...
def main():
	...
	parser.add_argument('--features', type=str, default='./mats/')
	parser.add_argument('--labels', type=str, default='/datasets/TAMUvalSegmented')
	...
	labels = {subset: np.array([labelDict[subset][name.split('.')[0]] for name in names[subset]]) for subset in ['query', 'gallery']}
